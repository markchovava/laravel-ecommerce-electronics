                        ...
                        <div class="widget-column">
                            ...
                            <ul class="list-unstyled products-group">
                                <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                    <div class="col-auto">
                                        <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('frontend/assets/images/75x75/2.png') }}" alt="Image Description"></a>
                                    </div>
                                ...
                                <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                    <div class="col-auto">
                                        <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('frontend/assets/images/75x75/1.png') }}" alt="Image Description"></a>
                                    </div>
                                    <div class="col pl-4 d-flex flex-column">
                                ...
                                <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                    <div class="col-auto">
                                        <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center">
                                            <img class="img-fluid" src="{{ asset('frontend/assets/images/75x75/3.png') }}" alt="Image Description"></a>
                                    </div>
                                    <div class="col pl-4 d-flex flex-column">
                    ...
                    <div class="col-wd-3 col-lg-4">
                        ...
                        <ul class="list-unstyled products-group">
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center">
                                        <img class="img-fluid" src="{{ asset('frontend/assets/images/75x75/1.png') }}" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('frontend/assets/images/75x75/3.png') }}" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
