                            ...
                            @if( $category_first->products[0] )
                                <div class="card product__item">
                                    ...
                                    <div class="img__area">
                                        ...
                                        src="{{ (isset($category_first->products[0]->product_thumbnail)) ? url('storage/products/thumbnail/' . $category_first->products[0]->product_thumbnail) : url('storage/products/thumbnail/no_image.jpg') }}" 
                                    ...
                                    <div class="flex-center-between my-3">
                                        <div class="prodcut-price">
                                            <div class="text-gray-100">
                                                @php
                                                    $usd_price = intval($category_first->products[0]->price);
                                                    $discount = ($category_first->products[0]->discounts->discount_percent / 100) * $usd_price;
                        ...
                        @if(isset($category_second->products))
                            @if( $category_second->products[0] )
                                <div class="card product__item">
                                    ...
                                    <div class="img__area">
                                        <img class="card-img-top" 
                                        src="{{ (isset($category_second->products[0]->product_thumbnail)) ? url('storage/products/thumbnail/' . $category_second->products[0]->product_thumbnail) : url('storage/products/thumbnail/no_image.jpg') }}" 
                                    ...
                                    <div class="flex-center-between my-3">
                                        <div class="prodcut-price">
                                            <div class="text-gray-100">
                                                @php
                                                    $usd_price = intval($category_second->products[0]->price);
                                                    $discount = ($category_second->products[0]->discounts->discount_percent / 100) * $usd_price;
                                                    $discount_usd_price = $usd_price - $discount;
                                                    $price = $discount_usd_price / 100;
                                                @endphp
                                                <span class="price__number">${{ number_format((float)$price, 2, '.', '') }}</span>
                        ...
                        @if(isset($category_third->products))
                            @if( $category_third->products[0] )
                                <div class="card product__item">
                                    ...
                                    <div class="img__area">
                                        <img class="card-img-top" 
                                        src="{{ (isset( $category_third->products[0]->product_thumbnail )) ? url('storage/products/thumbnail/' . $category_third->products[0]->product_thumbnail) : url('storage/products/thumbnail/no_image.jpg') }}" 
                                    ...
                                    <div class="flex-center-between my-3">
                                        <div class="prodcut-price">
                                            <div class="text-gray-100">
                                                @php
                                                    $usd_price = intval($category_third->products[0]->price);
                                                    $discount = ($category_third->products[0]->discounts->discount_percent / 100) * $usd_price;
                                                    $discount_usd_price = $usd_price - $discount;
                                                    $price = $discount_usd_price / 100;
                                                @endphp
                                                <span class="price__number">${{ number_format((float)$price, 2, '.', '') }}</span>
                        ...
                        @if(isset($category_forth->products))  
                            @if( $category_forth->products[0] )
                                <div class="card product__item">
                                    ...
                                    <div class="img__area">
                                        <img class="card-img-top" 
                                        src="{{ (isset( $category_forth->products[0]->product_thumbnail )) ? url('storage/products/thumbnail/' . $category_forth->products[0]->product_thumbnail) : url('storage/products/thumbnail/no_image.jpg') }}" 
                                    ...
                                    <div class="flex-center-between my-3">
                                        <div class="prodcut-price">
                                            <div class="text-gray-100">
                                                @php
                                                    $usd_price = intval($category_forth->products[0]->price);
                                                    $discount = ($category_forth->products[0]->discounts->discount_percent / 100) * $usd_price;
                                                    $discount_usd_price = $usd_price - $discount;
                                                    $price = $discount_usd_price / 100;
                                                @endphp
                                                <span class="price__number">${{ number_format((float)$price, 2, '.', '') }}</span>
                                    ...
                                    <div class="border-top pt-2 flex-center-between flex-wrap">
                                        <a href="#" id="{{ $category_forth->products[0]->id }}" class="text-gray-6 font-size-13"><i class="ec ec-compare mr-1 font-size-15"></i>
                                        Add To Quote
                                    </a>
                                    </div>
                                </div>
                        ...
                        @if(isset($category_fifth->products))
                            @if( $category_fifth->products[0] )
                                <div class="card product__item">
                                    ...
                                    <div class="img__area">
                                        <img class="card-img-top" 
                                        src="{{ (isset($category_fifth->products[0]->product_thumbnail)) ? url('storage/products/thumbnail/' . $category_fifth->products[0]->product_thumbnail) : url('storage/tags/no_image.jpg') }}" 
                                    ...
                                    <div class="flex-center-between my-3">
                                        <div class="prodcut-price">
                                            <div class="text-gray-100">
                                                @php
                                                    $usd_price = intval($category_fifth->products[0]->price);
                                                    $discount = ($category_fifth->products[0]->discounts->discount_percent / 100) * $usd_price;
                                                    $discount_usd_price = $usd_price - $discount;
                                                    $price = $discount_usd_price / 100;
                                                @endphp
                                                <span class="price__number">${{ number_format((float)$price, 2, '.', '') }}</span>
                        ...
                        @if(isset($category_sixth->products))
                            @if( $category_sixth->products[0] )
                                <div class="card product__item">
                                    ...
                                    <div class="img__area">
                                        <img class="card-img-top" 
                                        src="{{ (isset( $category_sixth->products[0]->product_thumbnail)) ? url('storage/products/thumbnail/' . $category_sixth->products[0]->product_thumbnail) : url('storage/tags/no_image.jpg') }}" 
                                    ...
                                    <div class="flex-center-between my-3">
                                        <div class="prodcut-price">
                                            <div class="text-gray-100">
                                                @php
                                                    $usd_price = intval($category_sixth->products[0]->price);
                                                    $discount = ($category_sixth->products[0]->discounts->discount_percent / 100) * $usd_price;
                                                    $discount_usd_price = $usd_price - $discount;
                                                    $price = $discount_usd_price / 100;
                                                @endphp
                                                <span class="price__number">${{ number_format((float)$price, 2, '.', '') }}</span>
                        ...
                        @if(isset($category_seventh->products))
                            @if( $category_seventh->products[0] )
                                <div class="card product__item">
                                    ...
                                    <div class="img__area">
                                        <img class="card-img-top" 
                                        src="{{ (isset($category_second->products[0]->product_thumbnail)) ? url('storage/products/thumbnail/' . $category_second->products[0]->product_thumbnail) : url('storage/tags/no_image.jpg') }}" 
                                        alt="{{ $category_second->products[0]->name }}">
                                    </div>
                                    <div class="flex-center-between my-3">
                                        <div class="prodcut-price">
                                            <div class="text-gray-100">
                                                @php
                                                    $usd_price = intval($category_seventh->products[0]->price);
                                                    $discount = ($category_seventh->products[0]->discounts->discount_percent / 100) * $usd_price;
                                                    $discount_usd_price = $usd_price - $discount;
                                                    $price = $discount_usd_price / 100;
                                                @endphp
                                                <span class="price__number">${{ number_format((float)$price, 2, '.', '') }}</span>
