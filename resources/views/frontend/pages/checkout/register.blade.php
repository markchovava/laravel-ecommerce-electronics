                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 order-lg-1">
                            <div class="pb-7 mb-7">
                                ...
                                <form class="" action="{{ route('checkout.register.process') }}" method="POST">
                                    @csrf
                                    <!-- Billing Form -->
                                    <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="js-form-message mb-6">
                                                ...
                                                <input type="name" class="form-control" name="email" placeholder="abc@example.com" data-msg="Please enter your email here." autocomplete="off">
                                            </div>
                                            <!-- End Input -->
                                        </div>
                                        <div class="col-md-12">
