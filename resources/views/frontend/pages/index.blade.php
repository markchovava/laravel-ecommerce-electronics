                                ...
                                <div class="product-item__outer h-100">
                                    <div class="product-item__inner bg-white px-wd-3 p-2 p-md-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <h5 class="mb-1 product-item__title"><a href="../shop/single-product-fullwidth.html" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                            <div class="mb-2">
                                                <a href="../shop/single-product-fullwidth.html" class="d-block text-center"><img class="img-fluid" src="{{ asset('frontend/assets/images/212x200/4.png') }}" alt="Image Description"></a>
                                            </div>
                                            <div class="flex-center-between mb-1">
                                                <div class="prodcut-price">
                                                    <div class="text-gray-100">$685,00</div>
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 mb-4 mb-xl-0">
                    <a href="../shop/shop.html" class="d-block">
                        <img class="img-fluid" src="{{ asset('frontend/assets/images/690x150/1.png') }}" alt="Image Description">
                    </a>
                </div>
                <div class="col-md-6 mb-4 mb-xl-0">
                    <a href="../shop/shop.html" class="d-block">
                        <img class="img-fluid" src="{{ asset('frontend/assets/images/690x150/2.png') }}" alt="Image Description">
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class=" d-flex justify-content-between border-bottom border-color-1 flex-lg-nowrap flex-wrap border-md-down-top-0 border-md-down-bottom-0 mb-4">
                    ...
                    <ul class="w-100 w-lg-auto nav nav-pills nav-tab-pill nav-tab-pill-fill mb-3 mb-lg-2 pt-3 pt-lg-0 border-top border-color-1 border-lg-top-0 align-items-center font-size-15 font-size-15-lg flex-nowrap flex-lg-wrap overflow-auto overflow-lg-visble pr-0" id="pills-tab-4" role="tablist">
                        <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                            <a class="nav-link rounded-pill active" id="Bpills-one-example1-tab" data-toggle="pill" 
                            href="#Bpills-one-example1" role="tab" aria-controls="Bpills-one-example1" aria-selected="true">
                                -80% off</a>
                        </li>
                    </ul>
                            ...
                            <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                <div class="product-item__body pb-xl-2">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        src="{{ asset('frontend/assets/images/212x200/3.png') }}" alt="Image Description"></a>
                                    </div>
                                    <div class="flex-center-between mb-1">
                                        <div class="prodcut-price">
                                            <div class="text-gray-100">$685,00</div>
                        ...
                        <div class="product-item__outer h-100">
                            <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                <div class="product-item__body pb-xl-2">
                                    ...
                                    <div class="mb-2">
                                        <a href="../shop/single-product-fullwidth.html" class="d-block text-center"><img class="img-fluid" 
                                            src="{{ asset('frontend/assets/images/212x200/1.png') }}" alt="Image Description"></a>
                                    </div>
                                    <div class="flex-center-between mb-1">
                                        <div class="prodcut-price">
                                            <div class="text-gray-100">$685,00</div>
        ...
        <div class="mb-8">
            <a href="../shop/shop.html" class="d-block text-gray-90">
                <div class="" style="background-image: url({{ asset('frontend/assets/images/1400x206/1.png') }});">
        ...
        <div class="mb-6">
                ...
                <div class="d-flex justify-content-between border-bottom border-color-1 flex-xl-nowrap flex-wrap border-md-down-top-0 border-lg-down-bottom-0 mb-3">
                    ...
                    <ul class="w-100 w-xl-auto nav nav-pills nav-tab-pill mb-2 pt-3 pt-xl-0 mb-0 border-top border-color-1 border-xl-top-0 align-items-center font-size-15 font-size-15-lg flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble pr-0" id="pills-tab-3" role="tablist">
                        <li class="nav-item flex-shrink-0 flex-xl-shrink-1">
                            <a class="nav-link rounded-pill active" id="Dpills-one-example1-tab" data-toggle="pill" href="#Dpills-one-example1" role="tab" aria-controls="Dpills-one-example1" aria-selected="true">
                                Top 20</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg">
                    <a href="../shop/shop.html" class="d-block"><img class="img-fluid" src="{{ asset('frontend/assets/img/39x370/img1.jpg') }}" alt="Image Description"></a>
                </div>
        ...
        <div class="mb-11">
            ...
            <div class="col-md-6 mb-4 mb-xl-0 col-xl-4 col-wd-3 flex-shrink-0 flex-xl-shrink-1">
                <a href="../shop/shop.html" class="min-height-132 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
                    <div class="col-6 col-xl-7 col-wd-6 pr-0">
                        <img class="img-fluid" src="{{ asset('frontend/assets/images/246x176/3.png') }}" alt="Image Description">
                    </div>
            ...
            <div class="col-md-6 mb-4 mb-xl-0 col-xl-4 col-wd-3 flex-shrink-0 flex-xl-shrink-1">
                <a href="../shop/shop.html" class="min-height-132 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
                    <div class="col-6 col-xl-7 col-wd-6 pr-0">
                        <img class="img-fluid" src="{{ asset('frontend/assets/images/246x176/2.png') }}" alt="Image Description">
                    </div>
                    <div class="col-6 col-xl-5 col-wd-6 pr-xl-4 pr-wd-3">
                        <div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
            ...
            <div class="col-md-6 mb-4 mb-xl-0 col-xl-4 col-wd-3 flex-shrink-0 flex-xl-shrink-1">
                <a href="../shop/shop.html" class="min-height-132 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
                    <div class="col-6 col-xl-7 col-wd-6 pr-0">
                        <img class="img-fluid" src="{{ asset('frontend/assets/images/246x176/1.png') }}" alt="Image Description">
                    </div>
                    <div class="col-6 col-xl-5 col-wd-6 pr-xl-4 pr-wd-3">
                        <div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
                            CATCH BIG <strong>DEALS</strong> ON THE CAMERAS
