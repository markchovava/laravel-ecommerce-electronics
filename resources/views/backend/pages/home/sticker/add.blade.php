...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form method="post" action="" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row">
                @csrf
                <!--begin::Aside column-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                <!--begin::Label-->
                                <label class="required form-label">Sticker Name</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="sticker_name" class="form-control mb-2" placeholder="Sticker Name" value="" />
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <input type="text" name="sticker_description" class="form-control mb-2" placeholder="Add Description..." value="" />
                                <!--end::Editor-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">Set a description to the sticker for better visibility.</div>
                                <!--end::Description-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
