                ...
                <div class="flex-lg-row-fluid ms-lg-7 ms-xl-10">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
												...
												<!--begin::Form-->
												<form id="repy__form" class="rounded border mt-10">
													<!--begin::Body-->
													<div class="d-block">
                                                        <!--begin::Subject-->
														<div class="border-bottom">
															<input class="form-control border-0 px-8 min-h-45px" name="reply_email" placeholder="Email" />
														</div>
														<!--end::Subject-->
														<!--begin::Subject-->
														<div class="border-bottom">
															<input class="form-control border-0 px-8 min-h-45px" name="reply_subject" placeholder="Subject" />
														</div>
														<!--end::Subject-->
														<!--begin::Message-->
                                                        <textarea name="reply_message" id="" class="form-control" cols="30" rows="10"></textarea>
														<!--end::Message-->
													</div>
													<!--end::Body-->
													<!--begin::Footer-->
